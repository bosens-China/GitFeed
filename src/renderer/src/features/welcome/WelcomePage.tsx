      ...
      <div className="flex h-full flex-col overflow-hidden bg-[var(--ant-color-bg-layout)]">
        ...
        <div className="flex min-h-[60px] shrink-0 items-center justify-between gap-4 border-b border-[var(--ant-color-border-secondary)] bg-[var(--ant-color-bg-container)] px-6 py-3.5">
          <div className="flex items-center gap-2.5">
            <LayoutGrid size={18} className="text-[var(--ant-color-primary)] shrink-0" />
            <span className="text-base font-semibold text-[var(--ant-color-text)]">
              {t('nav.overview', { defaultValue: '项目概览' })}
            </span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              {t('sidebar.addBtn', { defaultValue: '添加工程' })}
            </Button>
          </div>
        </div>

        {/* 欢迎引导空状态 */}
        <div className="flex flex-1 flex-col items-center justify-center p-6 md:p-12 overflow-auto">
      ...
      <div className="flex min-h-[60px] shrink-0 items-center justify-between gap-4 border-b border-[var(--ant-color-border-secondary)] bg-[var(--ant-color-bg-container)] px-6 py-3.5">
        <div className="flex items-center gap-2.5">
          ...
          <Tag color="blue" bordered={false} className="m-0 font-mono text-xs">
            {repositories.length} {t('stats.activeRepos', { defaultValue: '个工程' })}
          </Tag>
        </div>

        <div className="flex items-center gap-2">
          <Button icon={<FileText size={14} />} onClick={onNavigateToWeeklyReport}>
